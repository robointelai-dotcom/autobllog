...
export const SiteSchema = new mongoose.Schema({
  ...
  scheduleMode: { type: String, enum: ['manual','everySeconds','everyHours','randomHourly','dailyTime','cron','once'], default:'manual' },
  everySeconds: { type: Number, min: 1, max: 100000000, default: null },
  everyHours:   { type: Number, min: 1, max: 8760, default: 1 },
  randomHours:  { type: Number, min: 1, max: 8760, default: 1 },
  randomMinuteMin: { type: Number, min: 0, max: 59, default: 0 },
  randomMinuteMax: { type: Number, min: 0, max: 59, default: 59 },
  nextRandomRunAt: { type: Date, default: null },
